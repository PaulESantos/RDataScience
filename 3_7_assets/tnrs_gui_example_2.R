...
names[is.na(names)] <- ""
names$morphospecies.final <- paste(names$family.final, names$name.final, names$Unmatched_terms, sep=" ")
...
# At this point you still have to join your final names back to the original plot 
# data file. I'll leave that to you!
