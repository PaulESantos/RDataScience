...
There a few tricks to get this up and running once you've created an RStudio project and added the cloned version our repo:
  ...
  * Set the project build tools to website (click project name on the top right, then project options)
...
* To set up some of the meta-info for the website, click **Build Website** (which appears after you've set the project build tools to 'Website')
